...
void lt_dump_script (FILE* f)
{
  ...
  fputs ("#\n", f);
  fputs ("# The pcrecpp_unittest program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"pcrecpp_unittest.exe:pcrecpp_unittest:${LINENO}: libtool wrapper (GNU libtool) 2.2.10\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"pcrecpp_unittest.exe:pcrecpp_unittest:${LINENO}: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"pcrecpp_unittest.exe:pcrecpp_unittest:${LINENO}: newargv[0]: $progdir/$program\" 1>&2\n", f);
