...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# pcre_scanner_unittest - temporary wrapper script for .libs/pcre_scanner_unittest.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.2.10\n", f);
  fputs ("#\n", f);
  fputs ("# The pcre_scanner_unittest program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"pcre_scanner_unittest.exe:pcre_scanner_unittest:${LINENO}: libtool wrapper (GNU libtool) 2.2.10\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"pcre_scanner_unittest.exe:pcre_scanner_unittest:${LINENO}: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"pcre_scanner_unittest.exe:pcre_scanner_unittest:${LINENO}: newargv[0]: $progdir/$program\" 1>&2\n", f);
