...
const char * LIB_PATH_VALUE   = "d:\\pcre-8.12\\.libs;C:\\MinGW\\lib\\gcc\\mingw32\\4.5.2;";
const char * EXE_PATH_VARNAME = "PATH";
const char * EXE_PATH_VALUE   = "d:\\pcre-8.12\\.libs;C:\\MinGW\\lib\\gcc\\mingw32\\4.5.2;d:\\pcre-8.12\\build\\lib;d:\\pcre-8.12\\build\\bin;";
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# pcre_stringpiece_unittest - temporary wrapper script for .libs/pcre_stringpiece_unittest.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.2.10\n", f);
  fputs ("#\n", f);
  fputs ("# The pcre_stringpiece_unittest program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("  notinst_deplibs=' libpcrecpp.la /d/pcre-8.12/libpcre.la c:/mingw/bin/../lib/gcc/mingw32/4.5.2/libstdc++.la'\n", f);
  fputs ("else\n", f);
  ...
  fputs ("        lt_dump_D=`$ECHO \"X$lt_script_arg0\" | /mingw/bin/sed -e 's/^X//' -e 's%/[^/]*$%%'`\n", f);
  fputs ("        test \"X$lt_dump_D\" = \"X$lt_script_arg0\" && lt_dump_D=.\n", f);
  fputs ("        lt_dump_F=`$ECHO \"X$lt_script_arg0\" | /mingw/bin/sed -e 's/^X//' -e 's%^.*/%%'`\n", f);
  ...
  fputs ("    echo \"pcre_stringpiece_unittest.exe:pcre_stringpiece_unittest:${LINENO}: libtool wrapper (GNU libtool) 2.2.10\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"pcre_stringpiece_unittest.exe:pcre_stringpiece_unittest:${LINENO}: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"pcre_stringpiece_unittest.exe:pcre_stringpiece_unittest:${LINENO}: newargv[0]: $progdir/$program\" 1>&2\n", f);
  ...
  fputs ("    fi\n", f);
  fputs ("\n", f);
  fputs ("    file=`$ECHO \"$file\" | /mingw/bin/sed 's%^.*/%%'`\n", f);
  fputs ("    file=`ls -ld \"$thisdir/$file\" | /mingw/bin/sed -n 's/.*-> //p'`\n", f);
  fputs ("  done\n", f);
  fputs ("\n", f);
  ...
  fputs ("    *[\\\\/].libs ) thisdir=`$ECHO \"$thisdir\" | /mingw/bin/sed 's%[\\\\/][^\\\\/]*$%%'` ;;\n", f);
  fputs ("    .libs )   thisdir=. ;;\n", f);
  fputs ("    esac\n", f);
  fputs ("  fi\n", f);
  fputs ("\n", f);
  ...
  fputs ("    PATH=\"/d/pcre-8.12/.libs:/mingw/lib/gcc/mingw32/4.5.2:$PATH\"\n", f);
  fputs ("\n", f);
  fputs ("    # Some systems cannot cope with colon-terminated PATH\n", f);
  fputs ("    # The second colon is a workaround for a bug in BeOS R4 sed\n", f);
  fputs ("    PATH=`$ECHO \"$PATH\" | /mingw/bin/sed 's/::*$//'`\n", f);
  fputs ("\n", f);
  fputs ("    export PATH\n", f);
  fputs ("\n", f);
  fputs ("    # Add the dll search path components to the executable PATH\n", f);
  fputs ("    PATH=/d/pcre-8.12/.libs:/mingw/lib/gcc/mingw32/4.5.2:/d/pcre-8.12/build/lib:/d/pcre-8.12/build/bin:$PATH\n", f);
  fputs ("\n", f);
  fputs ("    if test \"$libtool_execute_magic\" != \"%%%MAGIC variable%%%\"; then\n", f);
