...
const char * LIB_PATH_VALUE   = "d:\\pcre-8.12\\.libs;";
const char * EXE_PATH_VARNAME = "PATH";
const char * EXE_PATH_VALUE   = "d:\\pcre-8.12\\.libs;d:\\pcre-8.12\\build\\lib;d:\\pcre-8.12\\build\\bin;";
...
void lt_dump_script (FILE* f)
{
  ...
  fputs ("  notinst_deplibs=' libpcreposix.la /d/pcre-8.12/libpcre.la'\n", f);
  fputs ("else\n", f);
  ...
  fputs ("    echo \"pcregrep.exe:pcregrep:${LINENO}: libtool wrapper (GNU libtool) 2.2.10\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"pcregrep.exe:pcregrep:${LINENO}: newargv[0]: $progdir/$program\" 1>&2\n", f);
  ...
  fputs ("    PATH=\"/d/pcre-8.12/.libs:$PATH\"\n", f);
  fputs ("\n", f);
  ...
  fputs ("    PATH=/d/pcre-8.12/.libs:/d/pcre-8.12/build/lib:/d/pcre-8.12/build/bin:$PATH\n", f);
  fputs ("\n", f);
  fputs ("    if test \"$libtool_execute_magic\" != \"%%%MAGIC variable%%%\"; then\n", f);
